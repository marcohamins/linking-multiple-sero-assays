...
# run stan model #####
sim_noise <- readRDS(paste0(getwd(),"/sim_noise.RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_HAI_",whichsamp,".RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_IgG_",whichsamp,".RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_IgM_",whichsamp,".RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_HAI_IgM_",whichsamp,".RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_IgM_IgG_",whichsamp,".RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_HAI_IgG_",whichsamp,".RDS"))
...
for(i in 1:4){
  ...
  fit$save_object(file = paste0(getwd(),"/stan_output/fit_",stanfile,"_sim_noise_nonLog_",whichsamp,".RDS"))
